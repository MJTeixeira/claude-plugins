---
name: unity
description: Any work in a Unity project — read before running Unity CLI/batchmode, tests, builds, or asset/animation work. A factory window drives Unity headlessly with no editor open, and the batchmode traps here are the ones that silently produce a green run that tested nothing.
---
